...
contract MarketLensTest is BaseTest {
    ...
    function testGetBorrowFee() public {
        address cauldronAddress = constants.cauldronAddressMap(ChainId.Mainnet, "Stargate-USDT", 3);
    ...
    function testGetInterestPerYear() public {
        address cauldronAddress = constants.cauldronAddressMap(ChainId.Mainnet, "xSUSHI", 2);
    ...
    function testGetMaxUserBorrowForCauldronV3() public {
        address cauldronAddress = constants.cauldronAddressMap(ChainId.Mainnet, "CRV", 4);
    ...
    function testGetMaxMarketBorrowForCauldronV3() public {
        ...
        address cauldronAddress2 = constants.cauldronAddressMap(ChainId.Mainnet, "CRV", 4);
        uint256 response2 = lens.getMaxMarketBorrowForCauldronV3(ICauldronV3(cauldronAddress2));
        assertEq(response2, 0);

        address cauldronAddress3 = constants.cauldronAddressMap(ChainId.Mainnet, "yv-3Crypto", 4);
    ...
    function testGetCollateralPrice() public {
        ...
        address cauldronAddress2 = constants.cauldronAddressMap(ChainId.Mainnet, "xSUSHI", 2);
    ...
    function testGetUserLtv() public {
        ...
        address shibCauldron = constants.cauldronAddressMap(ChainId.Mainnet, "SHIB", 2);
    ...
    function testGetHealthFactorForVolatile() public {
        address cauldronAddress = constants.cauldronAddressMap(ChainId.Mainnet, "WBTC", 4);
    ...
    function testGetUserLiquidationPrice() public {
        ...
        address cauldronAddress2 = constants.cauldronAddressMap(ChainId.Mainnet, "Stargate-USDT", 3);
    ...
    function testGetUserMaxBorrow() public {
        _setUpArbitrum();
        address cauldronAddress = constants.cauldronAddressMap(ChainId.Arbitrum, "magicGLP", 4);
