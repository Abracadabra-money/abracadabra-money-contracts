...
contract MarketLensTest is BaseTest {
    ...
    function testGetCollateralPrice() public {
        ...
        address cauldronAddress2 = constants.cauldronAddressMap("mainnet", "xSUSHI", 2);
    ...
    function testGetUserLiquidationPrice() public {
        ...
        address cauldronAddress2 = constants.cauldronAddressMap("mainnet", "Stargate-USDT", 3);
    ...
    function testGetUserMaxBorrow() public {
        _setUpArbitrum();
        address cauldronAddress = constants.cauldronAddressMap("arbitrum", "magicGLP", 4);
