...
contract BoundSpellLayerZeroScript is BaseScript {
    bytes32 constant BOUNDSPELL_FEEHANDLER_SALT = keccak256(bytes("BoundSpell_FeeHandler_1727105732"));
    bytes32 constant OFTV2_SALT = keccak256(bytes("BoundSpell_OFTV2_1727105732"));
