...
contract CauldronFeeWithdrawerScript is BaseScript {
    function deploy() public returns (CauldronFeeWithdrawer withdrawer) {
        if (block.chainid == ChainId.Mainnet) {
            //return _deployMainnet();
        } else if (block.chainid == ChainId.Avalanche) {
            //return _deployAvalanche();
...
/*
    function _deployMainnet() public returns (CauldronFeeWithdrawer withdrawer) {
    ...
    function _deployAvalanche() public returns (CauldronFeeWithdrawer withdrawwr) {
    ...
    function _deployArbitrum() public returns (CauldronFeeWithdrawer withdrawer) {
    ...
    function _deployFantom() public returns (CauldronFeeWithdrawer withdrawer) {
