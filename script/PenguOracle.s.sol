...
contract PenguOracleScript is BaseScript {
    ...
    function deploy() public {
        ...
        ProxyOracle oracle = ProxyOracle(deploy("Pengu_ProxyOracle", "ProxyOracle.sol:ProxyOracle"));
        address erc20Oracle = deploy("Pengu_ERC20Oracle", "ERC20Oracle.sol:ERC20Oracle", abi.encode("Pengu/USD", aggregator, 0));
        IOracle impl = IOracle(
            deploy("Pengu_InverseERC20Oracle", "InverseOracle.sol:InverseOracle", abi.encode("Pengu/USD", erc20Oracle, PENGU_DECIMALS))
        );
