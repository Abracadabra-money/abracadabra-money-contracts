...
contract Constants {
    ...
    constructor(Vm _vm) {
        ...
        setAddress("arbitrum.cauldronV4WithRewarder", 0xe45217A77C332FF767112dC89E568c473c5fad2b);
        ...
        setAddress("arbitrum.mimCauldronDistributor", 0x642C3B5C6092348F7e7E005DA79B87AFdfD3411D);
        ...
        // v4WithRewarder
        addCauldron("arbitrum", "abracadabraWrappedStakedGlpWithRewarder", 0x6272841716c198fC6bA48a5c58CCa6aD2BA566d1, 4, false);
