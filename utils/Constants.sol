...
contract Constants {
    ...
    constructor(Vm _vm) {
        ...
        setAddress("arbitrum.cauldronV4WithRewarder", 0xd404BEF05E9e256765440A1B9a6B56750c4cedEc);
        ...
        setAddress("arbitrum.mimCauldronDistributor", 0xE2601e7e0923A0D879E9206FCAa902ce25aEb7DD);
        ...
        // v4WithRewarder
        addCauldron("arbitrum", "abracadabraWrappedStakedGlpWithRewarder", 0xdCA1514b98bec62aBA0610f23F579F36c79e6ed2, 4, false);
