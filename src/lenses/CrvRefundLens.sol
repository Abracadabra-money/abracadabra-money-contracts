...
contract CrvRefundLens {
    ...
    address constant FEE_WITHDRAWER = 0x9cC903e42d3B14981C2109905556207C6527D482;
    ...
    function handleFees(ICauldronV4[] calldata cauldrons, uint128 refund) external {
        uint128 totalFeesWithdrawn = 0;
